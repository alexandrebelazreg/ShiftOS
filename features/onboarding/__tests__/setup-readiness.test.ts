...
const completeSector = () => ({ ...createEmptySector("sector_1"), name: "Accueil", hours: createEmptySector().hours.map((day) => day.day === "monday" ? { ...day, closed: false } : day), coverage: { standardDay: "monday" as const, profiles: { monday: buildHourlyProfile("09:00", "18:00") } }, weeklyDistribution: { monday: 100, tuesday: 0, wednesday: 0, thursday: 0, friday: 0, saturday: 0, sunday: 0 } })
